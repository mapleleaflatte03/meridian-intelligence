...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"{BOLD}{MAGENTA}Meridian Air-Gapped Researcher{RESET}")
    print(f"{BOLD}{RED}[SECURITY CLEARANCE] Air-Gapped Sovereign Mode Engaged. Routing inference to local GPU. Zero external data transmission.{RESET}")
